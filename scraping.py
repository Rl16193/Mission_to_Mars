...
#function for Hemisphere Images
def hemisphere_images(browser):
    ...
    for i in range (1,4):
        #browse each article
        browser.links.find_by_partial_text('Hemisphere')[i].button.click()
...
def scrape_all():
    ...
    image_url = hemisphere_images(browser)
